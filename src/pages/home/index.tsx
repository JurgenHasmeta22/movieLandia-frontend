...
export default function Home() {
	...
	async function getMovies(): Promise<void> {
		if (!searchParams.get('page') && !searchParams.get('search') && !searchParams.get('sortBy')) {
			...
			const responseMovies: IMoviesResponse = await moviesController.getMoviesSortingNoPagination(
				searchParams.get('sortBy')
			);
			...
			const responseMovies: IMoviesResponse = await moviesController.getMoviesSortingWithPagination(
				searchParams.get('sortBy'),
				searchParams.get('page')
			);
			setMovies(responseMovies.rows);
